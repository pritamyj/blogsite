          ...
          <div class="post-content">
            <div class="post-image">
              ...
              <div class="post-info">
                ...
                <?php endif ?>
                data-id="<?php echo $q['id'] ?>"></i> 
                <span class="dislikes"><?php echo getDislikes($q['id']); ?></span></h4> 
              </div>
                ...
                <div class="site-content">
                  <div class="posts">
                   ...
                   <form method="POST" style="display: inline-block;">
                    ...
                    <button class="btnn"> <a href="edit.php?id=<?php echo $q['id']; ?>", style="text-decoration: none;color: white;font-size: 1.8rem;">EDIT</a></button>
                  </form></div> 
                </div>
              </div>
            </div>
